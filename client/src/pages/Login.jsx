      ...
      >
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to your Cloth Couture account</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="#" className="text-sm text-primary hover:text-primary-dark">Forgot password?</Link>
                </div>
                <Input
                  id="password"
                  type="password"
